# Production domain: goldetech.com

The application is configured to use:

- Public origin: `https://goldetech.com`
...
5. Optionally add `www.goldetech.com` and configure it to redirect to the apex domain.

## Verification

After DNS and certificate provisioning complete, verify:

- `https://goldetech.com/` loads the GOLD-e AI landing page.
- `https://goldetech.com/pricing` loads pricing.
- `https://goldetech.com/login` loads authentication.
- `https://goldetech.com/api/health` returns the Cloud Run API health response.

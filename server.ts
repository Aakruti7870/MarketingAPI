...
app.post("/api/admin/keys/save", async (req: Request, res: Response) => {
...
app.post("/api/admin/keys/verify", async (req: Request, res: Response) => {
...
app.post("/api/admin/keys/verify-all", async (req: Request, res: Response) => {
  const tasks = [];
...
app.delete("/api/admin/keys/clear", (req: Request, res: Response) => {

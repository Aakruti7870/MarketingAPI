...
import GoldeAIHome from "./pages/GOLD-eAIHome";
...
function PublicPage({ children, legal = true }) { return <>{children}{legal && <PublicLegalLinks />}</>; }
